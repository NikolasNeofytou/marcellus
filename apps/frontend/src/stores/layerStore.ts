...
const sky130Layers: LayerDef[] = [
  // ── Wells ──
  { id: 0,  name: "nwell",  color: "#3b82f6", fillAlpha: 0.20, strokeAlpha: 0.6, visible: true,  selectable: true, locked: false, fillPattern: "hatch", order: 0,  group: "well",      gdsLayer: 64,  gdsDatatype: 20, alias: "NW",   material: "well",      sheetResistance: 900,  thickness: 3.0, height: 0 },
  { id: 1,  name: "pwell",  color: "#ef4444", fillAlpha: 0.20, strokeAlpha: 0.6, visible: true,  selectable: true, locked: false, fillPattern: "hatch", order: 1,  group: "well",      gdsLayer: 122, gdsDatatype: 16, alias: "PW",   material: "well",      sheetResistance: 1050, thickness: 3.0, height: 0 },
  // ── Diffusion ──
  { id: 2,  name: "diff",   color: "#22c55e", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 2,  group: "diffusion", gdsLayer: 65,  gdsDatatype: 20, alias: "DIFF", material: "diffusion", sheetResistance: 100,  thickness: 0.13, height: 0 },
  { id: 3,  name: "tap",    color: "#a855f7", fillAlpha: 0.25, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 3,  group: "diffusion", gdsLayer: 65,  gdsDatatype: 44, alias: "TAP",  material: "diffusion" },
  // ── Polysilicon ──
  { id: 4,  name: "poly",   color: "#f97316", fillAlpha: 0.35, strokeAlpha: 0.8, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 4,  group: "poly",      gdsLayer: 66,  gdsDatatype: 20, alias: "POLY", material: "poly",      sheetResistance: 48,   thickness: 0.18, height: 0.14 },
  // ── Contacts ──
  { id: 5,  name: "licon",  color: "#06b6d4", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "cross", order: 5,  group: "contact",   gdsLayer: 66,  gdsDatatype: 44, alias: "LICON", material: "cut",     sheetResistance: 120 },
  // ── Local Interconnect ──
  { id: 6,  name: "li1",    color: "#ec4899", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 6,  group: "metal",     gdsLayer: 67,  gdsDatatype: 20, alias: "LI",   material: "metal",     sheetResistance: 12.5, thickness: 0.1,  height: 0.93 },
  { id: 7,  name: "mcon",   color: "#84cc16", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "cross", order: 7,  group: "contact",   gdsLayer: 67,  gdsDatatype: 44, alias: "MCON", material: "cut",       sheetResistance: 9.3 },
  // ── Metal 1 ──
  { id: 8,  name: "met1",   color: "#6366f1", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 8,  group: "metal",     gdsLayer: 68,  gdsDatatype: 20, alias: "M1",   material: "metal",     sheetResistance: 0.125, thickness: 0.36, height: 1.02 },
  // ── Via 1 ──
  { id: 9,  name: "via",    color: "#f59e0b", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "cross", order: 9,  group: "via",       gdsLayer: 68,  gdsDatatype: 44, alias: "VIA1", material: "cut",       sheetResistance: 4.5 },
  // ── Metal 2 ──
  { id: 10, name: "met2",   color: "#14b8a6", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 10, group: "metal",     gdsLayer: 69,  gdsDatatype: 20, alias: "M2",   material: "metal",     sheetResistance: 0.125, thickness: 0.36, height: 1.74 },
  // ── Via 2 ──
  { id: 11, name: "via2",   color: "#d97706", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "cross", order: 11, group: "via",       gdsLayer: 69,  gdsDatatype: 44, alias: "VIA2", material: "cut",       sheetResistance: 3.4 },
  // ── Metal 3 ──
  { id: 12, name: "met3",   color: "#0ea5e9", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 12, group: "metal",     gdsLayer: 70,  gdsDatatype: 20, alias: "M3",   material: "metal",     sheetResistance: 0.047, thickness: 0.845, height: 2.37 },
  // ── Via 3 ──
  { id: 13, name: "via3",   color: "#c2410c", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "cross", order: 13, group: "via",       gdsLayer: 70,  gdsDatatype: 44, alias: "VIA3", material: "cut",       sheetResistance: 3.4 },
  // ── Metal 4 ──
  { id: 14, name: "met4",   color: "#8b5cf6", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 14, group: "metal",     gdsLayer: 71,  gdsDatatype: 20, alias: "M4",   material: "metal",     sheetResistance: 0.047, thickness: 0.845, height: 3.78 },
  // ── Via 4 ──
  { id: 15, name: "via4",   color: "#9a3412", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "cross", order: 15, group: "via",       gdsLayer: 71,  gdsDatatype: 44, alias: "VIA4", material: "cut",       sheetResistance: 0.38 },
  // ── Metal 5 (thick top metal) ──
  { id: 16, name: "met5",   color: "#e11d48", fillAlpha: 0.30, strokeAlpha: 0.7, visible: true,  selectable: true, locked: false, fillPattern: "solid", order: 16, group: "metal",     gdsLayer: 72,  gdsDatatype: 20, alias: "M5",   material: "metal",     sheetResistance: 0.029, thickness: 1.26, height: 5.30 },
  // ── Implants ──
